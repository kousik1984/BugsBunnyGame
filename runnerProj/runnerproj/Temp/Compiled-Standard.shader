...
SubShader { 
 ...
 //        d3d11: 160 avg math (137..183), 5 avg texture (3..7), 7 avg branch (6..8)
 Pass {
  Name "FORWARD"
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL FOG_LINEAR 
-- Vertex shader for "d3d11":
// No shader variant for this keyword set. The closest match will be used instead.

-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 144 math, 13 temp registers, 3 textures, 6 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 3
Set CUBE Texture "unity_SpecCube0" to slot 2 sampler slot 0
Set CUBE Texture "unity_SpecCube1" to slot 3 sampler slot -1
...
//
  ...
  10: rsq r1.w, r1.w
  11: mul r3.xyz, r1.wwww, v2.xyzx
  12: eq r2.w, cb5[0].x, l(1.000000)
  13: if_nz r2.w
  14:   eq r2.w, cb5[0].y, l(1.000000)
  15:   mul r4.xyz, v4.wwww, cb5[2].xyzx
  16:   mad r4.xyz, cb5[1].xyzx, v3.wwww, r4.xyzx
  17:   mad r4.xyz, cb5[3].xyzx, v5.wwww, r4.xyzx
  18:   add r4.xyz, r4.xyzx, cb5[4].xyzx
  19:   mov r5.y, v3.w
  20:   mov r5.z, v4.w
  21:   mov r5.w, v5.w
  22:   movc r4.xyz, r2.wwww, r4.xyzx, r5.yzwy
  ...
  25:   mad r2.w, r4.y, l(0.250000), l(0.750000)
  26:   mad r3.w, cb5[0].z, l(0.500000), l(0.750000)
  27:   max r4.x, r2.w, r3.w
  28:   sample r4.xyzw, r4.xzwx, t4.xyzw, s1
  29: else 
  30:   mov r4.xyzw, l(1.000000,1.000000,1.000000,1.000000)
  31: endif 
  32: dp4_sat r2.w, r4.xyzw, cb2[46].xyzw
  33: sample r4.xyzw, v1.xyxx, t1.xyzw, s3
  34: add r3.w, -cb0[9].y, l(1.000000)
  35: mad r3.w, r4.y, cb0[9].y, r3.w
  36: add r4.x, -cb0[8].w, l(1.000000)
  ...
  47:   mov r7.y, v4.w
  48:   mov r7.z, v5.w
  49:   add r8.xyz, -r7.xyzx, cb4[0].xyzx
  50:   div r8.xyz, r8.xyzx, r6.xyzx
  51:   add r9.xyz, -r7.xyzx, cb4[1].xyzx
  52:   div r9.xyz, r9.xyzx, r6.xyzx
  53:   lt r10.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r6.xyzx
  54:   movc r8.xyz, r10.xyzx, r8.xyzx, r9.xyzx
  55:   min r2.w, r8.y, r8.x
  56:   min r2.w, r8.z, r2.w
  57:   add r7.xyz, r7.xyzx, -cb4[2].xyzx
  58:   mad r6.xyz, r6.xyzx, r2.wwww, r7.xyzx
  59: else 
  60:   mov r6.xyz, r4.yzwy
  61: endif 
  ...
  65: sample_l r6.xyzw, r6.xyzx, t2.xyzw, s0, r2.w
  66: add r5.w, r6.w, l(-1.000000)
  67: mad r5.w, cb4[3].w, r5.w, l(1.000000)
  68: mul r5.w, r5.w, cb4[3].x
  69: mul r7.xyz, r6.xyzx, r5.wwww
  70: lt r6.w, cb4[1].w, l(0.999990)
  71: if_nz r6.w
  72:   lt r6.w, l(0.000000), cb4[6].w
  73:   if_nz r6.w
  74:     dp3 r6.w, r4.yzwy, r4.yzwy
  75:     rsq r6.w, r6.w
  76:     mul r8.xyz, r4.yzwy, r6.wwww
  ...
  78:     mov r9.y, v4.w
  79:     mov r9.z, v5.w
  80:     add r10.xyz, -r9.xyzx, cb4[4].xyzx
  81:     div r10.xyz, r10.xyzx, r8.xyzx
  82:     add r11.xyz, -r9.xyzx, cb4[5].xyzx
  83:     div r11.xyz, r11.xyzx, r8.xyzx
  84:     lt r12.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xyzx
  85:     movc r10.xyz, r12.xyzx, r10.xyzx, r11.xyzx
  86:     min r6.w, r10.y, r10.x
  87:     min r6.w, r10.z, r6.w
  88:     add r9.xyz, r9.xyzx, -cb4[6].xyzx
  89:     mad r4.yzw, r8.xxyz, r6.wwww, r9.xxyz
  90:   endif 
  91:   sample_l r8.xyzw, r4.yzwy, t3.xyzw, s0, r2.w
  92:   add r2.w, r8.w, l(-1.000000)
  93:   mad r2.w, cb4[7].w, r2.w, l(1.000000)
  94:   mul r2.w, r2.w, cb4[7].x
  95:   mul r4.yzw, r8.xxyz, r2.wwww
  96:   mad r6.xyz, r5.wwww, r6.xyzx, -r4.yzwy
  97:   mad r7.xyz, cb4[1].wwww, r6.xyzx, r4.yzwy
  98: endif 
  99: mul r4.yzw, r3.wwww, r7.xxyz
 100: mad r6.xyz, -v2.xyzx, r1.wwww, cb2[0].xyzx
 101: dp3 r1.w, r6.xyzx, r6.xyzx
 102: max r1.w, r1.w, l(0.001000)
 103: rsq r1.w, r1.w
 104: mul r6.xyz, r1.wwww, r6.xyzx
 105: dp3 r1.w, r2.xyzx, -r3.xyzx
 106: dp3_sat r2.w, r2.xyzx, cb2[0].xyzx
 107: dp3_sat r2.x, r2.xyzx, r6.xyzx
 108: dp3_sat r2.y, cb2[0].xyzx, r6.xyzx
 109: mul r2.z, r2.y, r2.y
 110: dp2 r2.z, r2.zzzz, r4.xxxx
 111: add r2.z, r2.z, l(-0.500000)
 112: add r3.x, -r2.w, l(1.000000)
 ...
 166: div r0.w, v2.w, cb1[5].y
 167: add r0.w, -r0.w, l(1.000000)
 168: mul r0.w, r0.w, cb1[5].z
 169: max r0.w, r0.w, l(0.000000)
 170: mad_sat r0.w, r0.w, cb3[1].z, cb3[1].w
 171: add r0.xyz, r0.xyzx, -cb3[0].xyzx
 172: mad o0.xyz, r0.wwww, r0.xyzx, cb3[0].xyzx
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL LIGHTPROBE_SH FOG_LINEAR 
-- Vertex shader for "d3d11":
// No shader variant for this keyword set. The closest match will be used instead.

-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 172 math, 15 temp registers, 6 textures, 8 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 3
Set CUBE Texture "unity_SpecCube0" to slot 2 sampler slot 0
Set CUBE Texture "unity_SpecCube1" to slot 3 sampler slot -1
...
//
  ...
  30:   mov r4.xyzw, l(1.000000,1.000000,1.000000,1.000000)
  31: endif 
  32: dp4_sat r4.x, r4.xyzw, cb2[46].xyzw
  33: sample r5.xyzw, v1.xyxx, t1.xyzw, s3
  34: add r4.y, -cb0[9].y, l(1.000000)
  35: mad r4.y, r5.y, cb0[9].y, r4.y
  36: add r4.z, -cb0[8].w, l(1.000000)
  ...
  67: else 
  68:   mov r2.w, l(1.000000)
  69:   dp4 r8.x, cb2[39].xyzw, r2.xyzw
  70:   dp4 r8.y, cb2[40].xyzw, r2.xyzw
  71:   dp4 r8.z, cb2[41].xyzw, r2.xyzw
  72: endif 
  73: add r7.xyz, r8.xyzx, v6.xyzx
  74: max r7.xyz, r7.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  75: log r7.xyz, r7.xyzx
 ...
 206: div r0.w, v2.w, cb1[5].y
 207: add r0.w, -r0.w, l(1.000000)
 208: mul r0.w, r0.w, cb1[5].z
 209: max r0.w, r0.w, l(0.000000)
 210: mad_sat r0.w, r0.w, cb3[1].z, cb3[1].w
 211: add r0.xyz, r0.xyzx, -cb3[0].xyzx
 212: mad o0.xyz, r0.wwww, r0.xyzx, cb3[0].xyzx
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL SHADOWS_SCREEN FOG_LINEAR 
-- Vertex shader for "d3d11":
// No shader variant for this keyword set. The closest match will be used instead.

-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 155 math, 13 temp registers, 4 textures, 6 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_ShadowMapTexture" to slot 1 sampler slot 4
Set 2D Texture "_OcclusionMap" to slot 2 sampler slot 3
Set CUBE Texture "unity_SpecCube0" to slot 3 sampler slot 0
...
//
  ...
  24: mad r2.w, cb3[25].w, r3.w, r2.w
  25: mad_sat r2.w, r2.w, cb3[24].z, cb3[24].w
  26: eq r3.w, cb7[0].x, l(1.000000)
  27: if_nz r3.w
  28:   eq r3.w, cb7[0].y, l(1.000000)
  29:   mul r5.xyz, v4.wwww, cb7[2].xyzx
  30:   mad r5.xyz, cb7[1].xyzx, v3.wwww, r5.xyzx
  31:   mad r5.xyz, cb7[3].xyzx, v5.wwww, r5.xyzx
  32:   add r5.xyz, r5.xyzx, cb7[4].xyzx
  33:   movc r5.xyz, r3.wwww, r5.xyzx, r4.xyzx
  34:   add r5.xyz, r5.xyzx, -cb7[6].xyzx
  35:   mul r5.yzw, r5.xxyz, cb7[5].xxyz
  36:   mad r3.w, r5.y, l(0.250000), l(0.750000)
  37:   mad r4.w, cb7[0].z, l(0.500000), l(0.750000)
  38:   max r5.x, r3.w, r4.w
  39:   sample r5.xyzw, r5.xzwx, t5.xyzw, s1
  40: else 
  41:   mov r5.xyzw, l(1.000000,1.000000,1.000000,1.000000)
  ...
  54: mad r5.xyz, r2.xyzx, -r5.xxxx, r3.xyzx
  55: mul r6.xyz, r2.wwww, cb0[2].xyzx
  56: lt r2.w, l(0.000000), cb6[2].w
  57: if_nz r2.w
  58:   dp3 r2.w, r5.xyzx, r5.xyzx
  59:   rsq r2.w, r2.w
  60:   mul r7.xyz, r2.wwww, r5.xyzx
  61:   add r8.xyz, -r4.xyzx, cb6[0].xyzx
  62:   div r8.xyz, r8.xyzx, r7.xyzx
  63:   add r9.xyz, -r4.xyzx, cb6[1].xyzx
  64:   div r9.xyz, r9.xyzx, r7.xyzx
  65:   lt r10.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r7.xyzx
  66:   movc r8.xyz, r10.xyzx, r8.xyzx, r9.xyzx
  67:   min r2.w, r8.y, r8.x
  68:   min r2.w, r8.z, r2.w
  69:   add r8.xyz, r4.xyzx, -cb6[2].xyzx
  70:   mad r7.xyz, r7.xyzx, r2.wwww, r8.xyzx
  71: else 
  72:   mov r7.xyz, r5.xyzx
  73: endif 
  ...
  77: sample_l r7.xyzw, r7.xyzx, t3.xyzw, s0, r2.w
  78: add r5.w, r7.w, l(-1.000000)
  79: mad r5.w, cb6[3].w, r5.w, l(1.000000)
  80: mul r5.w, r5.w, cb6[3].x
  81: mul r8.xyz, r7.xyzx, r5.wwww
  82: lt r6.w, cb6[1].w, l(0.999990)
  83: if_nz r6.w
  84:   lt r6.w, l(0.000000), cb6[6].w
  85:   if_nz r6.w
  86:     dp3 r6.w, r5.xyzx, r5.xyzx
  87:     rsq r6.w, r6.w
  88:     mul r9.xyz, r5.xyzx, r6.wwww
  89:     add r10.xyz, -r4.xyzx, cb6[4].xyzx
  90:     div r10.xyz, r10.xyzx, r9.xyzx
  91:     add r11.xyz, -r4.xyzx, cb6[5].xyzx
  92:     div r11.xyz, r11.xyzx, r9.xyzx
  93:     lt r12.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r9.xyzx
  94:     movc r10.xyz, r12.xyzx, r10.xyzx, r11.xyzx
  95:     min r6.w, r10.y, r10.x
  96:     min r6.w, r10.z, r6.w
  97:     add r4.xyz, r4.xyzx, -cb6[6].xyzx
  98:     mad r5.xyz, r9.xyzx, r6.wwww, r4.xyzx
  99:   endif 
 100:   sample_l r9.xyzw, r5.xyzx, t4.xyzw, s0, r2.w
 101:   add r2.w, r9.w, l(-1.000000)
 102:   mad r2.w, cb6[7].w, r2.w, l(1.000000)
 103:   mul r2.w, r2.w, cb6[7].x
 104:   mul r4.xyz, r9.xyzx, r2.wwww
 105:   mad r5.xyz, r5.wwww, r7.xyzx, -r4.xyzx
 106:   mad r8.xyz, cb6[1].wwww, r5.xyzx, r4.xyzx
 107: endif 
 108: mul r4.xyz, r3.wwww, r8.xyzx
 109: mad r5.xyz, -v2.xyzx, r1.wwww, cb2[0].xyzx
 110: dp3 r1.w, r5.xyzx, r5.xyzx
 ...
 175: div r0.w, v2.w, cb1[5].y
 176: add r0.w, -r0.w, l(1.000000)
 177: mul r0.w, r0.w, cb1[5].z
 178: max r0.w, r0.w, l(0.000000)
 179: mad_sat r0.w, r0.w, cb5[1].z, cb5[1].w
 180: add r0.xyz, r0.xyzx, -cb5[0].xyzx
 181: mad o0.xyz, r0.wwww, r0.xyzx, cb5[0].xyzx
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL SHADOWS_SCREEN LIGHTPROBE_SH FOG_LINEAR 
-- Vertex shader for "d3d11":
// No shader variant for this keyword set. The closest match will be used instead.

-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 183 math, 15 temp registers, 7 textures, 8 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_ShadowMapTexture" to slot 1 sampler slot 4
Set 2D Texture "_OcclusionMap" to slot 2 sampler slot 3
Set CUBE Texture "unity_SpecCube0" to slot 3 sampler slot 0
...
//
  ...
  55: mul r7.xyz, r3.wwww, cb0[2].xyzx
  56: if_nz r4.w
  57:   eq r3.w, cb7[0].y, l(1.000000)
  58:   mul r8.xyz, v4.wwww, cb7[2].xyzx
  59:   mad r8.xyz, cb7[1].xyzx, v3.wwww, r8.xyzx
  60:   mad r8.xyz, cb7[3].xyzx, v5.wwww, r8.xyzx
  61:   add r8.xyz, r8.xyzx, cb7[4].xyzx
  62:   movc r8.xyz, r3.wwww, r8.xyzx, r4.xyzx
  63:   add r8.xyz, r8.xyzx, -cb7[6].xyzx
  64:   mul r8.yzw, r8.xxyz, cb7[5].xxyz
  65:   mul r3.w, r8.y, l(0.250000)
  66:   mul r4.w, cb7[0].z, l(0.500000)
  67:   mad r5.z, -cb7[0].z, l(0.500000), l(0.250000)
  68:   max r3.w, r3.w, r4.w
  69:   min r8.x, r5.z, r3.w
  70:   sample r9.xyzw, r8.xzwx, t5.xyzw, s1
  71:   add r10.xyz, r8.xzwx, l(0.250000, 0.000000, 0.000000, 0.000000)
  ...
  90: mad r8.xyz, r8.xyzx, l(1.055000, 1.055000, 1.055000, 0.000000), l(-0.055000, -0.055000, -0.055000, 0.000000)
  91: max r8.xyz, r8.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  92: lt r2.w, l(0.000000), cb6[2].w
  93: if_nz r2.w
  94:   dp3 r2.w, r6.xyzx, r6.xyzx
  95:   rsq r2.w, r2.w
  96:   mul r9.xyz, r2.wwww, r6.xyzx
  97:   add r10.xyz, -r4.xyzx, cb6[0].xyzx
  98:   div r10.xyz, r10.xyzx, r9.xyzx
  99:   add r11.xyz, -r4.xyzx, cb6[1].xyzx
 100:   div r11.xyz, r11.xyzx, r9.xyzx
 101:   lt r12.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r9.xyzx
 102:   movc r10.xyz, r12.xyzx, r10.xyzx, r11.xyzx
 103:   min r2.w, r10.y, r10.x
 104:   min r2.w, r10.z, r2.w
 105:   add r10.xyz, r4.xyzx, -cb6[2].xyzx
 106:   mad r9.xyz, r9.xyzx, r2.wwww, r10.xyzx
 107: else 
 108:   mov r9.xyz, r6.xyzx
 109: endif 
 ...
 113: sample_l r9.xyzw, r9.xyzx, t3.xyzw, s0, r2.w
 114: add r3.w, r9.w, l(-1.000000)
 115: mad r3.w, cb6[3].w, r3.w, l(1.000000)
 116: mul r3.w, r3.w, cb6[3].x
 117: mul r10.xyz, r9.xyzx, r3.wwww
 118: lt r4.w, cb6[1].w, l(0.999990)
 119: if_nz r4.w
 120:   lt r4.w, l(0.000000), cb6[6].w
 121:   if_nz r4.w
 122:     dp3 r4.w, r6.xyzx, r6.xyzx
 123:     rsq r4.w, r4.w
 124:     mul r11.xyz, r4.wwww, r6.xyzx
 125:     add r12.xyz, -r4.xyzx, cb6[4].xyzx
 126:     div r12.xyz, r12.xyzx, r11.xyzx
 127:     add r13.xyz, -r4.xyzx, cb6[5].xyzx
 128:     div r13.xyz, r13.xyzx, r11.xyzx
 129:     lt r14.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r11.xyzx
 130:     movc r12.xyz, r14.xyzx, r12.xyzx, r13.xyzx
 131:     min r4.w, r12.y, r12.x
 132:     min r4.w, r12.z, r4.w
 133:     add r4.xyz, r4.xyzx, -cb6[6].xyzx
 134:     mad r6.xyz, r11.xyzx, r4.wwww, r4.xyzx
 135:   endif 
 136:   sample_l r4.xyzw, r6.xyzx, t4.xyzw, s0, r2.w
 137:   add r2.w, r4.w, l(-1.000000)
 138:   mad r2.w, cb6[7].w, r2.w, l(1.000000)
 139:   mul r2.w, r2.w, cb6[7].x
 140:   mul r4.xyz, r4.xyzx, r2.wwww
 141:   mad r6.xyz, r3.wwww, r9.xyzx, -r4.xyzx
 142:   mad r10.xyz, cb6[1].wwww, r6.xyzx, r4.xyzx
 143: endif 
 144: mul r4.xyz, r5.xxxx, r10.xyzx
 145: mad r6.xyz, -v2.xyzx, r1.wwww, cb2[0].xyzx
 146: dp3 r1.w, r6.xyzx, r6.xyzx
...
//
  ...
  14: mul r0.xyz, v0.yyyy, cb2[1].xyzx
  15: mad r0.xyz, cb2[0].xyzx, v0.xxxx, r0.xyzx
  16: mad r0.xyz, cb2[2].xyzx, v0.zzzz, r0.xyzx
  17: mad r0.xyz, cb2[3].xyzx, v0.wwww, r0.xyzx
...
//
  ...
  33: dp4 r0.x, cb2[42].xyzw, r1.xyzw
  34: dp4 r0.y, cb2[43].xyzw, r1.xyzw
  35: dp4 r0.z, cb2[44].xyzw, r1.xyzw
  36: mad o6.xyz, cb2[45].xyzx, r0.wwww, r0.xyzx
  37: mov o6.w, l(0)
  38: mov o7.xyzw, l(0,0,0,0)
  39: ret 
// Approximately 0 instruction slots used
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL FOG_LINEAR VERTEXLIGHT_ON 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 22 math, 2 temp registers
Uses vertex data channel "Vertex"
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL LIGHTPROBE_SH FOG_LINEAR VERTEXLIGHT_ON 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 52 math, 5 temp registers
Uses vertex data channel "Vertex"
...
//
  ...
  29: mov o5.xyz, r1.xyzx
  30: add r2.xyzw, -r0.xxxx, cb2[3].xyzw
  31: add r3.xyzw, -r0.yyyy, cb2[4].xyzw
  32: add r0.xyzw, -r0.zzzz, cb2[5].xyzw
  ...
  41: mad r0.xyzw, r0.xyzw, cb2[6].xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
  ...
  46: mul r2.xyz, r0.yyyy, cb2[8].xyzx
  47: mad r2.xyz, cb2[7].xyzx, r0.xxxx, r2.xyzx
  48: mad r0.xyz, cb2[9].xyzx, r0.zzzz, r2.xyzx
  49: mad r0.xyz, cb2[10].xyzx, r0.wwww, r0.xyzx
  ...
  55: dp4 r3.x, cb2[42].xyzw, r1.xyzw
  56: dp4 r3.y, cb2[43].xyzw, r1.xyzw
  57: dp4 r3.z, cb2[44].xyzw, r1.xyzw
  58: mad r1.xyz, cb2[45].xyzx, r0.wwww, r3.xyzx
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL SHADOWS_SCREEN FOG_LINEAR VERTEXLIGHT_ON 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 25 math, 2 temp registers
Uses vertex data channel "Vertex"
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL SHADOWS_SCREEN LIGHTPROBE_SH FOG_LINEAR VERTEXLIGHT_ON 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 55 math, 6 temp registers
Uses vertex data channel "Vertex"
...
// No shader variant for this keyword set. The closest match will be used instead.
 ...
 // Stats for Fragment shader:
 //        d3d11: 108 avg math (83..150), 3 avg texture (2..4), 2 avg branch (2..4)
 Pass {
  Name "FORWARD_DELTA"
...
//////////////////////////////////////////////////////
Keywords set in this variant: POINT FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
//
   ...
   9: mov o0.xyzw, r1.xyzw
  10: mov o2.w, r1.z
  11: eq r1.x, cb0[9].w, l(0.000000)
  12: movc r1.xy, r1.xxxx, v2.xyxx, v3.xyxx
  13: mad o1.zw, r1.xxxy, cb0[7].xxxy, cb0[7].zzzw
  ...
  19: add o2.xyz, r1.xyzx, -cb1[4].xyzx
  20: mad r2.xyz, -r1.xyzx, cb2[0].wwww, cb2[0].xyzx
  21: mov o6.xyz, r1.xyzx
  22: mov r2.w, l(0)
  23: mov o3.xyzw, r2.wwwx
  24: mov o4.xyzw, r2.wwwy
  25: mov o5.w, r2.z
  26: dp3 r1.x, v1.xyzx, cb3[4].xyzx
  27: dp3 r1.y, v1.xyzx, cb3[5].xyzx
  28: dp3 r1.z, v1.xyzx, cb3[6].xyzx
  29: dp3 r1.w, r1.xyzx, r1.xyzx
  30: rsq r1.w, r1.w
  31: mul o5.xyz, r1.wwww, r1.xyzx
  32: mul r1.xyz, r0.yyyy, cb0[12].xyzx
  33: mad r1.xyz, cb0[11].xyzx, r0.xxxx, r1.xyzx
  34: mad r0.xyz, cb0[13].xyzx, r0.zzzz, r1.xyzx
  35: mad o7.xyz, cb0[14].xyzx, r0.wwww, r0.xyzx
  36: mov o8.xyzw, l(0,0,0,0)
  37: ret 
// Approximately 0 instruction slots used
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 98 math, 7 temp registers, 3 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
Set 2D Texture "_LightTexture0" to slot 1 sampler slot 2
Set 3D Texture "unity_ProbeVolumeSH" to slot 2 sampler slot 0
...
//
  ...
  31:   mov r5.xyzw, l(1.000000,1.000000,1.000000,1.000000)
  32: endif 
  33: dp4_sat r0.w, r5.xyzw, cb2[46].xyzw
  34: dp3 r1.w, r4.xyzx, r4.xyzx
  35: sample r4.xyzw, r1.wwww, t1.xyzw, s2
  36: mul r0.w, r0.w, r4.x
  37: mov r4.x, v3.w
 ...
 100: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
 101: mul r0.xyz, r0.xyzx, r3.xyzx
 102: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
 103: div r0.w, v2.w, cb1[5].y
 104: add r0.w, -r0.w, l(1.000000)
 105: mul r0.w, r0.w, cb1[5].z
 106: max r0.w, r0.w, l(0.000000)
 107: mad_sat r0.w, r0.w, cb3[1].z, cb3[1].w
 108: mul o0.xyz, r0.xyzx, r0.wwww
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 89 math, 7 temp registers, 2 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
Set 3D Texture "unity_ProbeVolumeSH" to slot 1 sampler slot 0
...
//
  ...
  27:   mov r4.xyzw, l(1.000000,1.000000,1.000000,1.000000)
  28: endif 
  29: dp4_sat r1.w, r4.xyzw, cb2[46].xyzw
  30: mul r4.xyz, r1.wwww, cb0[2].xyzx
  31: add r1.w, -cb0[8].w, l(1.000000)
  32: mov r5.x, v3.w
  33: mov r5.y, v4.w
  ...
  90: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
  91: mul r0.xyz, r0.xyzx, r3.xyzx
  92: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
  93: div r0.w, v2.w, cb1[5].y
  94: add r0.w, -r0.w, l(1.000000)
  95: mul r0.w, r0.w, cb1[5].z
  96: max r0.w, r0.w, l(0.000000)
  97: mad_sat r0.w, r0.w, cb3[1].z, cb3[1].w
  98: mul o0.xyz, r0.xyzx, r0.wwww
  99: mov o0.w, l(1.000000)
 100: ret 
// Approximately 0 instruction slots used
...
//////////////////////////////////////////////////////
Keywords set in this variant: SPOT FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
//
  ...
  30: rsq r1.w, r1.w
  31: mul o5.xyz, r1.wwww, r1.xyzx
  32: mul r1.xyzw, r0.yyyy, cb0[12].xyzw
  33: mad r1.xyzw, cb0[11].xyzw, r0.xxxx, r1.xyzw
  34: mad r1.xyzw, cb0[13].xyzw, r0.zzzz, r1.xyzw
  35: mad o7.xyzw, cb0[14].xyzw, r0.wwww, r1.xyzw
  36: mov o8.xyzw, l(0,0,0,0)
  37: ret 
// Approximately 0 instruction slots used
...
//
 ...
 107: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
 108: mul r0.xyz, r0.xyzx, r3.xyzx
 109: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
 110: div r0.w, v2.w, cb1[5].y
 111: add r0.w, -r0.w, l(1.000000)
 112: mul r0.w, r0.w, cb1[5].z
 113: max r0.w, r0.w, l(0.000000)
 114: mad_sat r0.w, r0.w, cb3[1].z, cb3[1].w
 115: mul o0.xyz, r0.xyzx, r0.wwww
...
//////////////////////////////////////////////////////
Keywords set in this variant: POINT_COOKIE FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
//
 ...
 102: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
 103: mul r0.xyz, r0.xyzx, r3.xyzx
 104: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
 105: div r0.w, v2.w, cb1[5].y
 106: add r0.w, -r0.w, l(1.000000)
 107: mul r0.w, r0.w, cb1[5].z
 108: max r0.w, r0.w, l(0.000000)
 109: mad_sat r0.w, r0.w, cb3[1].z, cb3[1].w
 110: mul o0.xyz, r0.xyzx, r0.wwww
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL_COOKIE FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
//
  ...
  30: rsq r1.w, r1.w
  31: mul o5.xyz, r1.wwww, r1.xyzx
  32: mul r1.xy, r0.yyyy, cb0[12].xyxx
  33: mad r0.xy, cb0[11].xyxx, r0.xxxx, r1.xyxx
  34: mad r0.xy, cb0[13].xyxx, r0.zzzz, r0.xyxx
  35: mad o7.xy, cb0[14].xyxx, r0.wwww, r0.xyxx
  36: mov o8.xyzw, l(0,0,0,0)
  37: ret 
...
//
  ...
  31:   mov r5.xyzw, l(1.000000,1.000000,1.000000,1.000000)
  32: endif 
  33: dp4_sat r1.w, r5.xyzw, cb2[46].xyzw
  34: sample r4.xyzw, r4.xyxx, t1.xyzw, s2
  35: mul r1.w, r1.w, r4.w
  36: mul r4.xyz, r1.wwww, cb0[2].xyzx
  37: add r1.w, -cb0[8].w, l(1.000000)
  ...
  96: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
  97: mul r0.xyz, r0.xyzx, r3.xyzx
  98: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
  99: div r0.w, v2.w, cb1[5].y
 100: add r0.w, -r0.w, l(1.000000)
 101: mul r0.w, r0.w, cb1[5].z
 102: max r0.w, r0.w, l(0.000000)
 103: mad_sat r0.w, r0.w, cb3[1].z, cb3[1].w
 104: mul o0.xyz, r0.xyzx, r0.wwww
 105: mov o0.w, l(1.000000)
 106: ret 
// Approximately 0 instruction slots used
...
//////////////////////////////////////////////////////
Keywords set in this variant: SPOT SHADOWS_DEPTH FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 121 math, 7 temp registers, 4 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_LightTexture0" to slot 1 sampler slot 3
Set 2D Texture "_LightTextureB0" to slot 2 sampler slot 4
Set 3D Texture "unity_ProbeVolumeSH" to slot 3 sampler slot 0
...
//
  ...
  37:   mad r1.w, r5.y, l(0.250000), l(0.750000)
  38:   mad r2.w, cb6[0].z, l(0.500000), l(0.750000)
  39:   max r5.x, r1.w, r2.w
  40:   sample r5.xyzw, r5.xzwx, t3.xyzw, s0
  41: else 
  42:   mov r5.xyzw, l(1.000000,1.000000,1.000000,1.000000)
...
//////////////////////////////////////////////////////
Keywords set in this variant: SPOT SHADOWS_DEPTH SHADOWS_SOFT FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
//
   ...
   9: mov o0.xyzw, r1.xyzw
  10: mov o2.w, r1.z
  11: eq r1.x, cb0[14].w, l(0.000000)
  12: movc r1.xy, r1.xxxx, v2.xyxx, v3.xyxx
  13: mad o1.zw, r1.xxxy, cb0[12].xxxy, cb0[12].zzzw
  14: mad o1.xy, v2.xyxx, cb0[11].xyxx, cb0[11].zwzz
  15: mul r1.xyz, v0.yyyy, cb3[1].xyzx
  16: mad r1.xyz, cb3[0].xyzx, v0.xxxx, r1.xyzx
  17: mad r1.xyz, cb3[2].xyzx, v0.zzzz, r1.xyzx
  18: mad r1.xyz, cb3[3].xyzx, v0.wwww, r1.xyzx
  ...
  30: rsq r1.w, r1.w
  31: mul o5.xyz, r1.wwww, r1.xyzx
  32: mul r1.xyzw, r0.yyyy, cb0[17].xyzw
  33: mad r1.xyzw, cb0[16].xyzw, r0.xxxx, r1.xyzw
  34: mad r1.xyzw, cb0[18].xyzw, r0.zzzz, r1.xyzw
  35: mad o7.xyzw, cb0[19].xyzw, r0.wwww, r1.xyzw
  36: mov o8.xyzw, l(0,0,0,0)
  37: ret 
// Approximately 0 instruction slots used
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 150 math, 11 temp registers, 4 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_LightTexture0" to slot 1 sampler slot 3
Set 2D Texture "_LightTextureB0" to slot 2 sampler slot 4
Set 3D Texture "unity_ProbeVolumeSH" to slot 3 sampler slot 0
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 100 math, 7 temp registers, 3 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
Set 2D Texture "_ShadowMapTexture" to slot 1 sampler slot 2
Set 3D Texture "unity_ProbeVolumeSH" to slot 2 sampler slot 0
...
//
  ...
  33:   mad r2.w, r4.y, l(0.250000), l(0.750000)
  34:   mad r3.w, cb6[0].z, l(0.500000), l(0.750000)
  35:   max r4.x, r2.w, r3.w
  36:   sample r4.xyzw, r4.xzwx, t2.xyzw, s0
  37: else 
  38:   mov r4.xyzw, l(1.000000,1.000000,1.000000,1.000000)
...
//////////////////////////////////////////////////////
Keywords set in this variant: DIRECTIONAL_COOKIE SHADOWS_SCREEN FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 32 math, 4 temp registers
Uses vertex data channel "Vertex"
...
//
  ...
  13: mad o1.xy, v2.xyxx, cb0[6].xyxx, cb0[6].zwzz
  14: mov o2.w, r1.z
  15: mul r2.xyz, v0.yyyy, cb3[1].xyzx
  16: mad r2.xyz, cb3[0].xyzx, v0.xxxx, r2.xyzx
  17: mad r2.xyz, cb3[2].xyzx, v0.zzzz, r2.xyzx
  18: mad r2.xyz, cb3[3].xyzx, v0.wwww, r2.xyzx
  19: add o2.xyz, r2.xyzx, -cb1[4].xyzx
  20: mad r3.xyz, -r2.xyzx, cb2[0].wwww, cb2[0].xyzx
  21: mov o6.xyz, r2.xyzx
  22: mov r3.w, l(0)
  23: mov o3.xyzw, r3.wwwx
...
//////////////////////////////////////////////////////
Keywords set in this variant: POINT SHADOWS_CUBE FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 119 math, 7 temp registers, 3 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_LightTexture0" to slot 1 sampler slot 3
Set 3D Texture "unity_ProbeVolumeSH" to slot 2 sampler slot 0
Set CUBE Texture "_ShadowMapTexture" to slot 3 sampler slot 1
...
//
 ...
 125: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
 126: mul r0.xyz, r0.xyzx, r3.xyzx
 127: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
 128: div r0.w, v2.w, cb1[5].y
 129: add r0.w, -r0.w, l(1.000000)
 130: mul r0.w, r0.w, cb1[5].z
 131: max r0.w, r0.w, l(0.000000)
 132: mad_sat r0.w, r0.w, cb5[1].z, cb5[1].w
 133: mul o0.xyz, r0.xyzx, r0.wwww
...
//////////////////////////////////////////////////////
Keywords set in this variant: POINT SHADOWS_CUBE SHADOWS_SOFT FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 125 math, 8 temp registers, 3 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_LightTexture0" to slot 1 sampler slot 3
Set 3D Texture "unity_ProbeVolumeSH" to slot 2 sampler slot 0
Set CUBE Texture "_ShadowMapTexture" to slot 3 sampler slot 1
...
//
 ...
 138: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
 139: mul r0.xyz, r0.xyzx, r3.xyzx
 140: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
 141: div r0.w, v2.w, cb1[5].y
 142: add r0.w, -r0.w, l(1.000000)
 143: mul r0.w, r0.w, cb1[5].z
 144: max r0.w, r0.w, l(0.000000)
 145: mad_sat r0.w, r0.w, cb5[1].z, cb5[1].w
 146: mul o0.xyz, r0.xyzx, r0.wwww
...
//////////////////////////////////////////////////////
Keywords set in this variant: POINT_COOKIE SHADOWS_CUBE FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
//
 ...
 127: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
 128: mul r0.xyz, r0.xyzx, r3.xyzx
 129: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
 130: div r0.w, v2.w, cb1[5].y
 131: add r0.w, -r0.w, l(1.000000)
 132: mul r0.w, r0.w, cb1[5].z
 133: max r0.w, r0.w, l(0.000000)
 134: mad_sat r0.w, r0.w, cb5[1].z, cb5[1].w
 135: mul o0.xyz, r0.xyzx, r0.wwww
...
//////////////////////////////////////////////////////
Keywords set in this variant: POINT_COOKIE SHADOWS_CUBE SHADOWS_SOFT FOG_LINEAR 
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 28 math, 3 temp registers
Uses vertex data channel "Vertex"
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 126 math, 8 temp registers, 4 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_LightTextureB0" to slot 1 sampler slot 4
Set CUBE Texture "_LightTexture0" to slot 2 sampler slot 3
Set 3D Texture "unity_ProbeVolumeSH" to slot 3 sampler slot 0
...
//
 ...
 140: mad r0.xyz, r4.xyzx, r0.wwww, r0.xyzx
 141: mul r0.xyz, r0.xyzx, r3.xyzx
 142: mad r0.xyz, r1.xyzx, r2.xzwx, r0.xyzx
 143: div r0.w, v2.w, cb1[5].y
 144: add r0.w, -r0.w, l(1.000000)
 145: mul r0.w, r0.w, cb1[5].z
 146: max r0.w, r0.w, l(0.000000)
 147: mad_sat r0.w, r0.w, cb5[1].z, cb5[1].w
 148: mul o0.xyz, r0.xyzx, r0.wwww
 149: mov o0.w, l(1.000000)
 150: ret 
// Approximately 0 instruction slots used
...
SubShader { 
 ...
 // Stats for Vertex shader:
 //        d3d11: 37 avg math (25..68)
 // Stats for Fragment shader:
 //        d3d11: 109 avg math (51..183), 4 avg texture (4..7), 4 avg branch (2..8)
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE"="FORWARDBASE" "SHADOWSUPPORT"="true" "RenderType"="Opaque" "PerformanceChecks"="False" }
  ZWrite [_ZWrite]
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 53 math, 7 temp registers, 4 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 4
Set 2D Texture "unity_NHxRoughness" to slot 2
Set CUBE Texture "unity_SpecCube0" to slot 3 sampler slot 0
...
//
   ...
   6: rsq r1.w, r1.w
   7: mul r2.xyz, r1.wwww, v5.xyzx
   8: eq r1.w, cb4[0].x, l(1.000000)
   9: if_nz r1.w
  10:   eq r1.w, cb4[0].y, l(1.000000)
  11:   mul r3.xyz, v4.wwww, cb4[2].xyzx
  12:   mad r3.xyz, cb4[1].xyzx, v3.wwww, r3.xyzx
  13:   mad r3.xyz, cb4[3].xyzx, v5.wwww, r3.xyzx
  14:   add r3.xyz, r3.xyzx, cb4[4].xyzx
  15:   mov r4.y, v3.w
  16:   mov r4.z, v4.w
  17:   mov r4.w, v5.w
  18:   movc r3.xyz, r1.wwww, r3.xyzx, r4.yzwy
  19:   add r3.xyz, r3.xyzx, -cb4[6].xyzx
  20:   mul r3.yzw, r3.xxyz, cb4[5].xxyz
  21:   mad r1.w, r3.y, l(0.250000), l(0.750000)
  22:   mad r2.w, cb4[0].z, l(0.500000), l(0.750000)
  23:   max r3.x, r1.w, r2.w
  24:   sample r3.xyzw, r3.xzwx, t4.xyzw, s1
  25: else 
  26:   mov r3.xyzw, l(1.000000,1.000000,1.000000,1.000000)
  ...
  38: sample_l r6.xyzw, r3.xzwx, t3.xyzw, s0, r1.w
  39: add r1.w, r6.w, l(-1.000000)
  40: mad r1.w, cb3[3].w, r1.w, l(1.000000)
  41: mul r1.w, r1.w, cb3[3].x
  42: mul r3.xzw, r6.xxyz, r1.wwww
  43: mul r3.xyz, r3.yyyy, r3.xzwx
  44: dp3 r1.w, -v2.xyzx, r2.xyzx
  45: add r2.w, r1.w, r1.w
  ...
  65: mov_sat r0.w, v2.w
  66: add r0.xyz, r0.xyzx, -cb2[0].xyzx
  67: mad o0.xyz, r0.wwww, r0.xyzx, cb2[0].xyzx
...
//
  ...
  67: mov_sat r0.w, v2.w
  68: add r0.xyz, r0.xyzx, -cb2[0].xyzx
  69: mad o0.xyz, r0.wwww, r0.xyzx, cb2[0].xyzx
...
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 30 math, 2 temp registers
Uses vertex data channel "Vertex"
Uses vertex data channel "Color"
Uses vertex data channel "TexCoord"
Uses vertex data channel "TexCoord0"
...
Constant Buffer "UnityFog" (32 bytes) on slot 4 {
  Vector4 unity_FogParams at 16
}
...
//
  ...
  13: mad o2.w, r0.x, cb4[1].z, cb4[1].w
  ...
  18: mul r0.xyz, v0.yyyy, cb2[1].xyzx
  19: mad r0.xyz, cb2[0].xyzx, v0.xxxx, r0.xyzx
  20: mad r0.xyz, cb2[2].xyzx, v0.zzzz, r0.xyzx
  21: mad r0.xyz, cb2[3].xyzx, v0.wwww, r0.xyzx
...
//
  ...
  11: mul r0.x, r0.x, cb1[5].z
  12: max r0.x, r0.x, l(0.000000)
  13: mad o2.w, r0.x, cb5[1].z, cb5[1].w
  14: eq r0.x, cb0[9].w, l(0.000000)
  15: movc r0.xy, r0.xxxx, v2.xyxx, v3.xyxx
  16: mad o1.zw, r0.xxxy, cb0[7].xxxy, cb0[7].zzzw
  17: mad o1.xy, v2.xyxx, cb0[6].xyxx, cb0[6].zwzz
  ...
  40: dp4 r3.x, cb2[42].xyzw, r2.xyzw
  41: dp4 r3.y, cb2[43].xyzw, r2.xyzw
  42: dp4 r3.z, cb2[44].xyzw, r2.xyzw
  43: mad r1.xyz, cb2[45].xyzx, r1.xxxx, r3.xyzx
  44: mov r0.w, l(1.000000)
  45: dp4 r2.x, cb2[39].xyzw, r0.xyzw
  46: dp4 r2.y, cb2[40].xyzw, r0.xyzw
  47: dp4 r2.z, cb2[41].xyzw, r0.xyzw
...
//
  ...
  41: dp4 r3.y, cb2[43].xyzw, r2.xyzw
  42: dp4 r3.z, cb2[44].xyzw, r2.xyzw
  43: mad r2.xyz, cb2[45].xyzx, r0.wwww, r3.xyzx
  44: mov r1.w, l(1.000000)
  45: dp4 r3.x, cb2[39].xyzw, r1.xyzw
  46: dp4 r3.y, cb2[40].xyzw, r1.xyzw
  47: dp4 r3.z, cb2[41].xyzw, r1.xyzw
  ...
  71: mul r1.xyz, r0.yyyy, cb2[8].xyzx
  72: mad r1.xyz, cb2[7].xyzx, r0.xxxx, r1.xyzx
  73: mad r0.xyz, cb2[9].xyzx, r0.zzzz, r1.xyzx
...
// No shader variant for this keyword set. The closest match will be used instead.
 ...
 // Stats for Vertex shader:
 //        d3d11: 33 avg math (26..39)
 // Stats for Fragment shader:
 //        d3d11: 51 avg math (33..105), 3 avg texture (3..5), 1 avg branch (0..2)
 Pass {
  Name "FORWARD_DELTA"
  Tags { "LIGHTMODE"="FORWARDADD" "SHADOWSUPPORT"="true" "RenderType"="Opaque" "PerformanceChecks"="False" }
  ZWrite Off
...
//
   ...
   8: mad r1.xyzw, cb4[20].xyzw, r1.wwww, r2.xyzw
   9: mov o0.xyzw, r1.xyzw
  10: div r1.x, r1.z, cb1[5].y
  11: add r1.x, -r1.x, l(1.000000)
  12: mul r1.x, r1.x, cb1[5].z
  13: max r1.x, r1.x, l(0.000000)
  14: mad o2.w, r1.x, cb5[1].z, cb5[1].w
  15: eq r1.x, cb0[9].w, l(0.000000)
  16: movc r1.xy, r1.xxxx, v2.xyxx, v3.xyxx
  17: mad o1.zw, r1.xxxy, cb0[7].xxxy, cb0[7].zzzw
  18: mad o1.xy, v2.xyxx, cb0[6].xyxx, cb0[6].zwzz
  19: mul r1.xyz, v0.yyyy, cb3[1].xyzx
  20: mad r1.xyz, cb3[0].xyzx, v0.xxxx, r1.xyzx
  21: mad r1.xyz, cb3[2].xyzx, v0.zzzz, r1.xyzx
  22: mad r1.xyz, cb3[3].xyzx, v0.wwww, r1.xyzx
  23: add r2.xyz, r1.xyzx, -cb1[4].xyzx
  24: dp3 r1.w, r2.xyzx, r2.xyzx
  25: rsq r1.w, r1.w
  26: mul o2.xyz, r1.wwww, r2.xyzx
  27: mad r2.xyz, -r1.xyzx, cb2[0].wwww, cb2[0].xyzx
  28: mov o6.xyz, r1.xyzx
  29: dp3 r1.x, r2.xyzx, r2.xyzx
  30: rsq r1.x, r1.x
  31: mul r1.xyz, r1.xxxx, r2.xyzx
  32: mov r1.w, l(0)
  33: mov o3.xyzw, r1.wwwx
  34: mov o4.xyzw, r1.wwwy
  35: mov o5.w, r1.z
  36: dp3 r1.x, v1.xyzx, cb3[4].xyzx
  37: dp3 r1.y, v1.xyzx, cb3[5].xyzx
  38: dp3 r1.z, v1.xyzx, cb3[6].xyzx
  39: dp3 r1.w, r1.xyzx, r1.xyzx
  40: rsq r1.w, r1.w
  41: mul o5.xyz, r1.wwww, r1.xyzx
...
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 36 math, 3 temp registers
Uses vertex data channel "Vertex"
Uses vertex data channel "Color"
Uses vertex data channel "TexCoord"
Uses vertex data channel "TexCoord0"
...
//
  ...
  28: mov o6.xyz, r1.xyzx
  29: mov r2.w, l(0)
  30: mov o3.xyzw, r2.wwwx
  31: mov o4.xyzw, r2.wwwy
  32: mov o5.w, r2.z
  33: dp3 r1.x, v1.xyzx, cb3[4].xyzx
  34: dp3 r1.y, v1.xyzx, cb3[5].xyzx
  35: dp3 r1.z, v1.xyzx, cb3[6].xyzx
  36: dp3 r1.w, r1.xyzx, r1.xyzx
  37: rsq r1.w, r1.w
  38: mul o5.xyz, r1.wwww, r1.xyzx
  39: mul r1.xy, r0.yyyy, cb0[12].xyxx
  40: mad r0.xy, cb0[11].xyxx, r0.xxxx, r1.xyxx
  41: mad r0.xy, cb0[13].xyxx, r0.zzzz, r0.xyxx
  42: mad o7.xy, cb0[14].xyxx, r0.wwww, r0.xyxx
...
//
  ...
  45: mov_sat r0.w, v2.w
  46: mul o0.xyz, r0.xyzx, r0.wwww
  47: mov o0.w, l(1.000000)
  48: ret 
// Approximately 0 instruction slots used
...
//
  ...
  44: mad r0.w, -cb0[8].z, l(0.779084), l(0.779084)
  45: mad r1.xyz, r1.xyzx, r0.wwww, r2.xyzx
  46: mul r0.xyz, r0.xyzx, r1.xyzx
  47: mov_sat r0.w, v2.w
  48: mul o0.xyz, r0.xyzx, r0.wwww
